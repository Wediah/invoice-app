...
(function( factory ){
	if ( true ) {
		// AMD
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! datatables.net-bs5 */ "./node_modules/datatables.net-rowgroup-bs5/node_modules/datatables.net-bs5/js/dataTables.bootstrap5.mjs"), __webpack_require__(/*! datatables.net-rowgroup */ "./node_modules/datatables.net-rowgroup-bs5/node_modules/datatables.net-rowgroup/js/dataTables.rowGroup.mjs")], __WEBPACK_AMD_DEFINE_RESULT__ = (function ( $ ) {
...
/***/ "./node_modules/datatables.net-rowgroup-bs5/node_modules/datatables.net-rowgroup/js/dataTables.rowGroup.mjs":
/*!******************************************************************************************************************!*\
  !*** ./node_modules/datatables.net-rowgroup-bs5/node_modules/datatables.net-rowgroup/js/dataTables.rowGroup.mjs ***!
  \******************************************************************************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var RowGroup = function ( dt, opts ) {
	...
	if ( ! datatables_net__WEBPACK_IMPORTED_MODULE_1__.versionCheck || ! datatables_net__WEBPACK_IMPORTED_MODULE_1__.versionCheck( '1.10.8' ) ) {
		throw 'RowGroup requires DataTables 1.10.8 or newer';
	}

	// User and defaults configuration object
	this.c = jquery__WEBPACK_IMPORTED_MODULE_0__.extend( true, {},
		datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.rowGroup,
		RowGroup.defaults,
		opts
	);
...
jquery__WEBPACK_IMPORTED_MODULE_0__.extend( RowGroup.prototype, {
	...
	_group: function ( level, rows ) {
		...
		var fn = datatables_net__WEBPACK_IMPORTED_MODULE_1__.ext.oApi._fnGetObjectDataFn( fns[ level ] );
		var dt = this.s.dt;
		var group, last;
		var data = [];
		var that = this;
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'rowGroup()', function () {
	return this;
} );

datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'rowGroup().disable()', function () {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'rowGroup().enable()', function ( opts ) {
	return this.iterator( 'table', function (ctx) {
		if ( ctx.rowGroup ) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'rowGroup().enabled()', function () {
...
datatables_net__WEBPACK_IMPORTED_MODULE_1__.Api.register( 'rowGroup().dataSrc()', function ( val ) {
	if ( val === undefined ) {
...
jquery__WEBPACK_IMPORTED_MODULE_0__(document).on( 'preInit.dt.dtrg', function (e, settings, json) {
	...
	var defaults = datatables_net__WEBPACK_IMPORTED_MODULE_1__.defaults.rowGroup;
