    ...
    value: function nest(str, fc) {
      ...
      while (match = this.nestingRegexp.exec(str)) {
        ...
        if (match[0].includes(this.formatSeparator) && !/{.*}/.test(match[1])) {
          ...
          var _match$1$split$map2 = (0,_babel_runtime_helpers_esm_toArray__WEBPACK_IMPORTED_MODULE_9__["default"])(_match$1$split$map);
  ...
  (0,_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Connector, [{
    ...
    value: function loaded(name, err, data) {
      var _name$split = name.split('|'),
          _name$split2 = (0,_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_10__["default"])(_name$split, 2),
          lng = _name$split2[0],
          ns = _name$split2[1];
    ...
    value: function loadOne(name) {
      ...
      var _name$split3 = name.split('|'),
          _name$split4 = (0,_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_10__["default"])(_name$split3, 2),
          lng = _name$split4[0],
          ns = _name$split4[1];
...
/* harmony export */   "i18nextXHRBackend": function() { return /* reexport safe */ i18next_xhr_backend__WEBPACK_IMPORTED_MODULE_1__["default"]; },
