...
<html lang="en">
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-12 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="" class="flex items-center ps-2.5 mb-5">
                <img src="{{ asset('assets/img/pages/spalshIMG2.png') }}" class="h-6 me-3 sm:h-7" alt="Apollo Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Apollo Invoice</span>
            </a>
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('invoice.create', ['slug' => $company->slug]) }}" class="flex items-center p-2
                    text-white rounded-lg dark:text-white hover:bg-blue-700 bg-blue-500 group"
                    >
                        <svg class="flex-shrink-0 w-6 h-6 text-white transition duration-75 dark:text-gray-400
                        group-hover:text-blue-100 dark:group-hover:text-white" aria-hidden="true"
                ...
                <li>
                    <a href="{{ route('company.show', ['slug' => $company->slug])}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    >
                ...
                <li>
                    <a href="{{ route('invoice.index', ['slug' => $company->slug]) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400
                        group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
                ...
                <li>
                    <a href="{{ route('company.show', ['slug' => $company->slug])}}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400
                        group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
