    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="mx-auto col-md-10">
            <h4 class="py-3 mb-4 breadcrumb-wrapper">
                <span class="text-muted fw-light"><a href="{{ route('dashboard') }}" style="color: #A8B1BB">All
                        Companies</a>
                    /</span>
                Create Company
            </h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-12">
                                        <label for="description" class="form-label blabel">company
                                            description</label>
                                        <textarea class="form-control" id="description" rows="3" maxlength="150" name="description">
                                      </textarea>
                                        @error('description')
                                            <p class="error">{{ $message }}</p>
                                        @enderror
