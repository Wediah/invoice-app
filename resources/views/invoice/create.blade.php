                            ...
                            <div class="col-md-6">
                                <dl class="mb-2 row">
                                    ...
                                    <dd class="col-sm-6 d-flex justify-content-md-end">
                                        <div class="w-px-150">
                                            <input type="text" class="form-control" disabled value="{{ $invoiceNumber
                                            }}"/>
                                        </div>
                                    </dd>
                                    <dt class="mb-2 col-sm-6 mb-sm-0 text-md-end">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                                ...
                                                <div class="mb-3 row g-4">
                                                    ...
                                                    <div class="mb-0 col">
                                                        ...
                                                        <input type="text" class="form-control no-border"
                                                               ...
                                                               aria-label="Enter Email Address" name="email"
                                                               aria-describedby="basic-addon11" value=""/>
                                                    </div>
                                                </div>
                                                <div class="mb-3 row g-4">
                                            ...
                                            <div class="modal-footer d-flex justify-content-between">
                                                ...
                                                <button type="button" id="invoiceTo" class="btn btn-primary">Apply
                                                    changes
                                                </button>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-3 col-12 pe-0">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="price"
                                                           class="form-control invoice-item-price " required readonly/>
                                                </div>
                ...
                <div class="mb-4 card">
                    <div class="card-body">
                        ...
                        <div class="my-3 d-flex">
                            ...
                            <button type="submit" class="btn btn-label-secondary w-100">Save</button>
                        </div>
