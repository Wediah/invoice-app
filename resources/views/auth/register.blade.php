    ...
    <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
            <div class="flex-row text-center mx-auto">
                ...
                <div class="mx-auto">
                    <h3>Launch the ultimate Invoicing Experience! 🚀</h3>
                    <p>
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
            <div class="w-px-400 mx-auto">
                ...
                <p class="mb-4">Create an account to launch the ultimate invoicing experience</p>
                ...
                <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <div class="" style="font-size: 12px">
                            By clicking the “Create your account” button, you agree to Apollo Invoice’s terms of
                            acceptable use and Data Processing Agreement. To learn more about how Apollo Invoice
                            collects, uses, and discloses your data, please read our Privacy Policy
                            <a href="javascript:void(0);">privacy policy & terms</a>
                        </div>
                    </div>
                    <button class="btn btn-primary d-grid w-100">Create Your Account</button>
                </form>

                <p class="">
                    <span>Already have an Apollo Invoice account?</span>
                    <a href="{{ 'login' }}">
                        <span>Sign In</span>
                    </a>
                </p>
